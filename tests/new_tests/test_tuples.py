...
def test_tuples(script):
    ...
    # lines[7], not lines[-1]: odlox now prints a call stack trace after the
    ...
    assert "Uncaught exception" in lines[7]
    assert "append" in lines[7].lower() or "list" in lines[7].lower()
