...
// `import mod` result and every built-in module (`sys`, `gfx`, ...; see
// the vm package's Phase 6) are exactly this shape, just populated
// differently (compiling `.lox` source vs. registering natives
// programmatically). `environment` is stored by reference: two "copies"
